...
(such as if there is a spam001.txt and spam005.txt but no spam002.txt).
...
DESCRIPTION = """Finds all files with a given prefix,
such as spam001.txt, spam002.txt, and so on,
in a single folder and locates any gaps in the numbering
(such as if there is a spam001.txt and spam005.txt but no spam002.txt).
Renames all the later files to close this gap.
...
parser.add_argument("path",
                    help="path to file series: <[folder\]prefix.ext>",
                    action="store",
                    default="spam.txt")
