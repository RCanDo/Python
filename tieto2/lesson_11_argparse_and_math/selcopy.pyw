...
DESCRIPTION = """Walks through a folder tree and searches for files
with names satisfying given standard Unix pattern
(passed with the use of wildcards '*', '?', etc.).
Copy these files from whatever location they are into a new folder.
"""
...
parser.add_argument('source', help="source files", action="store")

parser.add_argument('target', help="target files", action="store")

args = parser.parse_args()


source_folder, source_files = os.path.split(args.source)
