...
plt.plot(np.arange(0,10,.1), np.random.randn(100))

fig
ax_lst

plt.subplot(221)
plt.plot(np.arange(0,10,.1), np.random.randn(100),c='r')

#plt.subplot(222)
ax_lst[1,0].plot(np.arange(0,10,.1), np.random.randn(100),c='k')

#plt.subplot(223)
ax_lst[1,1].plot(np.arange(0,10,.1), np.random.randn(100),c='m')


fig, (ax1, ax2) = plt.subplots(2, 1)  # a figure with a 2x2 grid of Axes
plt.plot(np.arange(0,10,.1), np.random.randn(100))

ax1.plot(np.arange(0,10,.1), np.random.randn(100))
