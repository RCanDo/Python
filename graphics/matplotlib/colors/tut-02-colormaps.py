...
This can be done using the class `ListedColormap` or `LinearSegmentedColormap`.
...
Before manually creating or manipulating colormaps,
let us first see how we can obtain colormaps and their colors from existing colormap classes.
"""
#%%  Getting colormaps and accessing their values
"""
First, getting a named colormap, most of which are listed in 'Choosing Colormaps in Matplotlib',
...
and below we use a modest value of 8 so there are not a lot of values to look at.
"""
...
that takes one of more colormaps as input,
