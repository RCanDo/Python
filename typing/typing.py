...
# Notes
# -----
# isinstance(pd.Series, Iterable)   # True
# isinstance(pd.Series, Sequence)   # False
#  the same for np.array
#
# len(Iterable)     # no!  :/
# len(Sequence)     # ok
#
# df.index(pd.Index)                # ! i.e. only pd.Index "family"
# df.index.intersection(pd.Index)   #   "
