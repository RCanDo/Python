...
# method is called. To compute multiple gradients over the same computation, 
...
with tf.GradientTape(watch_accessed_variables=False, persistent=True) as tape:
  ...
  z = variable_b ** 3  # No gradients will be available since `variable_b` is
                       # not being watched.
dy_da = tape.gradient(y, variable_a)   # 6.
dz_db = tape.gradient(z, variable_b)   # None
